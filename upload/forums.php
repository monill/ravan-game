...
function forums_rank($tp)
{
    ...
    if ($tp < 3) {
        return "#1 Absolute Newbie";
    } else if ($tp < 7) {
        return "#2 Newbie";
    } else if ($tp < 12) {
        return "#3 Beginner";
    } else if ($tp < 18) {
        return "#4 Not Experienced";
    } else if ($tp < 25) {
        return "#5 Rookie";
    } else if ($tp < 50) {
        return "#6 Average";
        ...
        return "#9 Greater Than Average";
    } else if ($tp < 500) {
        return "#10 Experienced";
    } else if ($tp < 750) {
        return "#11 Highly Experienced";
    } else if ($tp < 1200) {
        return "#12 Honoured";
    } else if ($tp < 1800) {
        return "#13 Highly Hounoured";
    } else if ($tp < 2500) {
        return "#14 Respect King";
    } else if ($tp < 5000) {
        return "#15 True Champion";
    }
}
...
if ($_GET['viewtopic'] and $_GET['act'] != 'quote') {
    $_GET['act'] = 'viewtopic';
}
