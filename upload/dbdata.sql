...
INSERT INTO `cities`
VALUES ('1', 'Default City', 'A standard city added to start you off', 1);
...
VALUES ('Here you can put game news, or prehaps an update log.');
...
VALUES (NULL, 'validate_period', '15');
INSERT INTO `settings`
VALUES (NULL, 'validate_on', '0');
INSERT INTO `settings`
VALUES (NULL, 'regcap_on', '0');
INSERT INTO `settings`
VALUES (NULL, 'hospital_count', '0');
INSERT INTO `settings`
VALUES (NULL, 'jail_count', '0');
INSERT INTO `settings`
VALUES (NULL, 'sendcrys_on', '1');
INSERT INTO `settings`
VALUES (NULL, 'sendbank_on', '1');
INSERT INTO `settings`
VALUES (NULL, 'ct_refillprice', '12');
INSERT INTO `settings`
VALUES (NULL, 'ct_iqpercrys', '5');
INSERT INTO `settings`
VALUES (NULL, 'ct_moneypercrys', '200');
INSERT INTO `settings`
VALUES (NULL, 'staff_pad', 'Here you can store notes for all staff to see.');
INSERT INTO `settings`
VALUES (NULL, 'willp_item', '0');
INSERT INTO `settings`
VALUES (NULL, 'ravanversion', '2.5.01 (Build: 2501)');
...
ALTER TABLE `users`
    ADD `turns` INT( 11 ) NOT NULL DEFAULT '25';
...
ALTER TABLE `users`
    ADD `ratings` INT( 11 ) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `rates` INT( 11 ) NOT NULL DEFAULT '1';

ALTER TABLE `users`
    ADD `warehouse` INT(11) NOT NULL DEFAULT '0',
ADD `matches` INT(11) NOT NULL DEFAULT '0',
ADD `petrol` INT(11) NOT NULL DEFAULT '0';

ALTER TABLE `cities`
    ADD `citytravtime` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `traveltime` INT(11) NOT NULL DEFAULT '0';
...
INSERT INTO `battle_ladders` (`ladderId`, `ladderName`, `ladderLevel`)
VALUES (1, 'Beginner league', 0),
       (2, 'Amateur league', 5),
...
INSERT INTO `businesses_classes` (`classId`, `className`, `classDesc`, `classMembers`, `classCost`)
VALUES (1, 'Fireworks stand',
        'Our customers will explode in delight with our fireworks. Great for holidays or any special event.', 4,
        500000),
       (2, 'Hair salon',
        'A hair salon is a place where one goes to get their hair cut, as well as styled, highlighted or coloured.', 4,
        750000),
       (3, 'Law firm',
        'A law firm is a business entity formed by one or more lawyers to engage in the practice of law. The money made is determined by the work hours the company sells. The amount of employees will increase this, aswell as the hired lawyers stats.',
        6, 4000000),
       (4, 'Flower shop', 'A store where flowers are purchased.', 4, 100000),
       (5, 'Car dealership', 'Our customers need transportation. Sell them our best and send them on their way.', 8,
        6000000),
...
INSERT INTO `businesses_ranks` (`rankId`, `rankName`, `rankClass`, `rankCash`, `rankPrim`, `rankSec`, `rankPGain`,
                                `rankSGain`)
VALUES (1, 'Sales person', 1, 1000, 'IQ', 'labour', '30.50', '15.25'),
...
ALTER TABLE `users`
    ADD `comppoints` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `business` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `active` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `activedays` INT(11) NOT NULL DEFAULT '0';
ALTER TABLE businesses
    ADD bussecure INT( 11 ) NOT NULL DEFAULT '0';
ALTER TABLE users
    ADD rob INT( 11 ) NOT NULL DEFAULT '0';
ALTER TABLE userstats
    ADD robskill INT( 11 ) NOT NULL DEFAULT '0';
ALTER TABLE `users`
    ADD `bguard` INT( 11 ) NOT NULL DEFAULT '0';
...
VALUES ('NULL', 'Labour Pack [ +100 ]', '6', '10', '0', '0', '0', '0', '0', '100', '0'),
...
VALUES (1, 'Standard Crimes', 1);
INSERT INTO `crimegroups`
VALUES (2, 'Arson Crimes', 2);
INSERT INTO `crimegroups`
VALUES (3, 'Drug Crimes', 3);
INSERT INTO `crimegroups`
VALUES (4, 'Grand Theft Autos', 4);
INSERT INTO `crimegroups`
VALUES (5, 'Hitman Crimes', 5);
INSERT INTO `crimegroups`
VALUES (6, 'Theft Crimes', 6);
INSERT INTO `crimegroups`
VALUES (7, 'Virus Crimes', 7);
...
INSERT INTO `crimes`
VALUES (1, 'Near The Comunity Center', 1, '((WILL*0.8)/1)+(LEVEL/4)', 10, 0, 0, 1,
        '1. You head over to the Comunity Center.<br />\r\n2. You start scavenging for cash.<br />''',
        '<font color=green>Result: You collect ${money} from the gutters!',
        '<font color=orange>Result: There''s no change to be seen! ', '<font color=red>you got busted ', 10,
        'got busted', 10);
INSERT INTO `crimes`
VALUES (2, 'Under a shack', 1, '((WILL*0.8)/1.5)+(LEVEL/4)', 20, 0, 0, 1,
        '1. You head over to the shack of well-known Street Person, Dave.<br />\r\n2. You creep underneath and start scavenging for money.<br />''',
        '<font color=green>Result: You dig up ${money}!',
        '<font color=orange>Result: Dave finds you and says "What are you doin here?". You run off. ',
        '<font color=red>you got busted ', 5, 'got busted', 10);
INSERT INTO `crimes`
VALUES (3, 'Music CDS', 3, '((WILL*0.8)/3)+(LEVEL/4)', 30, 0, 0, 1,
        '1. You go down to the local market and buy some blank CDs.<br />\r\n2. You head home and burn some music onto these CDs.<br />\r\n3. You go back to the market, set up your shop, and wait for customers.<br />''',
        '<font color=green>Result: You sell your stock making you ${money}!',
        '<font color=orange>Result: No-one wants to buy your worthless junk! ', '<font color=red>you got busted ', 7,
        'got busted', 15);
INSERT INTO `crimes`
VALUES (4, 'DVDs', 3, '((WILL*0.8)/3.5)+(LEVEL/4)', 34, 0, 0, 1,
        '1. You go down to the local market and buy some blank DVDs.<br />\r\n2. You head home and burn some videos onto these CDs.<br />\r\n3. You go back to the market, set up your shop, and wait for customers.<br />''',
        '<font color=green>Result: You sell your stock making you ${money}!',
        '<font color=orange>Result: No-one wants to buy your worthless junk! ', '<font color=red>you got busted ', 10,
        'got busted', 15);
INSERT INTO `crimes`
VALUES (5, 'Dog Racing', 30, '((WILL*0.7)/30)+(LEVEL/5)', 50000, 0, 0, 1,
        '1. You set up the equipment required.<br />\r\n2. The target comes in.<br />\r\n3. You persuade him to make a bet of $50000 on a Dog.<br />\r\n4. Using delayed TV, you show him the race, knowing he has picked the wrong one.<br />''',
        '<font color=green><font color=green>Result: Operation Success!</font>',
        '<font color=orange><font color=brown>Result: You misread the Dog that won and made him bet on the wrong Dog! Doh!</font> ',
        '<font color=red>you got busted ', 60, 'got caught illegaly racen dogs', 60);
INSERT INTO `crimes`
VALUES (6, 'Fight Club', 85, '((WILL*0.7)/35.9)+(LEVEL/25)', 500000, 0, 0, 1,
        'You go down to the docks looking for the fight club. ''',
        '<font color=green>You get in and start whooping them one by one until you win ,a man comes up to you, and says that was the best fight he had seen in years and gives you a share of what he''s won, ${money} ! that''s all for you he says!',
        '<font color=orange>Right as you get in the cops bust in and start shooting, you get hit in the head and wake up in jail.sucks to be you! lol!  ',
        '<font color=red>you got busted ', 190, 'got caught in illegal fight club', 190);
INSERT INTO `crimes`
VALUES (7, 'Jacked up on PCP', 100, '((WILL*0.7)/35.9)+(LEVEL/75)', 1200000, 0, 0, 1, 'You have taken PCP!!!''',
        '<font color=green>You feel like nothing can hurt you so you run to the bank and rob it you get a half a million but that not good eough for you so you run back in and take all the gold too, looks like you made it out with ${money} you get home before the drug''s that you''re on ware off.',
        '<font color=orange>You  think you can''t be stoped and start running to a bank but on the way a bunch of cops are eating as you try to run by you trip and stumble, they see you and arrest you for being under the influence. ',
        '<font color=red>you got busted ', 200, 'got busted for assult think you where unstopable', 200);
INSERT INTO `crimes`
VALUES (8, 'The Big Score', 200, '((WILL*0.7)/35.9)+(LEVEL/125)', 8000000, 0, 0, 1, 'You decide to hack a bank!''',
        '<font color=green>You begain hacking the banks main frame you get passed all the fire walls and put ${money} in you swiss bank. ',
        '<font color=orange>You begain hacking the banks main frame when the F.B.I. bust thow your doors can you say busted! ',
        '<font color=red>you got busted ', 400, 'got caught hacking a bank', 400);
INSERT INTO `crimes`
VALUES (9, 'Burn a House', 30, '((WILL*0.7)/30)+(LEVEL/5)', 50000, 0, 0, 2,
        'You drench the house in gas\r\nand throw a match at it. \r\nAfter about 2 minutes, the house is engulfed in flames. \r\n''',
        '<font color=green>You think to youself\r\n"this rules, why didn''t I do this sooner?\r\n',
        '<font color=orange>the cops roll up \r\n ', '<font color=red>you get taken to jail for arson ', 60,
        'got busted for arson', 60);
INSERT INTO `crimes`
VALUES (10, 'Burn a Bridge', 85, '((WILL*0.7)/35.9)+(LEVEL/25)', 100000, 0, 0, 2,
        'You drench the Bridge in gas\r\nand throw a match at it. \r\nAfter about 2 minutes, the Bridge is engulfed in flames. \r\n''',
        '<font color=green>You think to youself\r\n"this rules, why didn''t I do this sooner?\r\n',
        '<font color=orange>the cops roll up \r\n ', '<font color=red>you get taken to jail for arson ', 190,
        'got busted for arson', 190);
INSERT INTO `crimes`
VALUES (11, 'Burn a Hotel', 100, '((WILL*0.7)/35.9)+(LEVEL/75)', 200000, 0, 0, 2,
        'You drench the Hotel in gas\r\nand throw a match at it. \r\nAfter about 2 minutes, the Hotel is engulfed in flames. \r\n''',
        '<font color=green>You think to youself\r\n"this rules, why didn''t I do this sooner?\r\n',
        '<font color=orange>the cops roll up \r\n ', '<font color=red>you get taken to jail for arson ', 200,
        'got busted for arson', 200);
INSERT INTO `crimes`
VALUES (12, 'Burn a Warehouse', 200, '((WILL*0.7)/35.9)+(LEVEL/125)', 250000, 0, 0, 2,
        'You drench the Warehouse in gas\r\nand throw a match at it. \r\nAfter about 2 minutes, the Warehouse is engulfed in flames. \r\n''',
        '<font color=green>You think to youself\r\n"this rules, why didn''t I do this sooner?\r\n',
        '<font color=orange>the cops roll up \r\n ', '<font color=red>you get taken to jail for arson ', 400,
        'got busted for arson', 400);
INSERT INTO `crimes`
VALUES (13, 'PCP', 8, '((WILL*0.8)/8)+(LEVEL/4)', 200, 0, 0, 3,
        '1. You pick up a load of PCP from your bud''s and drive south on the M1 highway.<br />\r\n2. You see coppers chasing after you, you turn off to avoid them.<br />''',
        '<font color=green>3. You get off their tail and deliver the goods, collecting your fee.<br />\r\n<font color=green>Result: You feel good with ${money} in your pocket!</font>',
        '<font color=orange><font color=brown>Result: As they pull nearer to you you leap out of the van and run off.</font> ',
        '<font color=red>you got busted running drugs!', 25, 'busted by the cops running drugs', 25);
INSERT INTO `crimes`
VALUES (14, 'Cannabis', 20, '((WILL*0.8)/8)+(LEVEL/4)', 500, 0, 0, 3,
        '1. You pick up a load of Cannabis from your bud''s and drive south on the M1 highway.<br />\r\n2. You see coppers chasing after you, you turn off to avoid them.<br />''',
        '<font color=green>3. You get off their tail and deliver the goods, collecting your fee.<br />\r\n<font color=green>Result: You feel good with ${money} in your pocket!</font>',
        '<font color=orange><font color=brown>Result: As they pull nearer to you you leap out of the van and run off.</font> ',
        '<font color=red>you got busted running drugs!', 25, 'busted by the cops running drugs', 25);
INSERT INTO `crimes`
VALUES (15, 'LSD', 40, '((WILL*0.8)/8)+(LEVEL/4)', 1000, 0, 0, 3,
        '1. You pick up a load of LSD from your bud''s and drive south on the M1 highway.<br />\r\n2. You see coppers chasing after you, you turn off to avoid them.<br />''',
        '<font color=green>3. You get off their tail and deliver the goods, collecting your fee.<br />\r\n<font color=green>Result: You feel good with ${money} in your pocket!</font>',
        '<font color=orange><font color=brown>Result: As they pull nearer to you you leap out of the van and run off.</font> ',
        '<font color=red>you got busted running drugs!', 25, 'busted by the cops running drugs', 25);
INSERT INTO `crimes`
VALUES (16, 'Get some cannibis', 90, '((WILL*0.7)/35.9)+(LEVEL/50)', 1000000, 0, 0, 3,
        'You go and tell the drug dealer that you want 100 lbs. of his best cannibis.''',
        '<font color=green>You take him to the spot and kick his Face in, you then take all the cannibis and sell it for ${money}.',
        '<font color=orange>You take him to the spot but right as you get there the cops are there waiting. Looks like Jail time! ',
        '<font color=red>you got busted ', 180, 'got caught running drugs', 180);
INSERT INTO `crimes`
VALUES (17, 'GS-R turbo', 20, '((WILL*0.8)/20)+(LEVEL/4)', 0, 0, 8009, 4,
        '1. You head down to the local car lot.<br />\r\n2. You spot a GS-R turbo, pretty shiny you''d say!<br />\r\n3. You throw a rock at the window and hop in!<br />''',
        '<font color=green>Result: You insert your fake key and take off with it you now have a new GS-R turbo!',
        '<font color=orange>Result: There''s no battery, so the car won''t run! You hop out and run away. ',
        '<font color=red>you got busted for GTA', 40, 'busted by the cops for jacking cars', 40);
INSERT INTO `crimes`
VALUES (18, 'Hummer', 28, '((WILL*0.7)/28)+(LEVEL/4)', 0, 0, 8011, 4,
        '1. You walking down a streetof a rich neighbourhood.<br />\r\n2. You see a red Hummer with the window down.<br />\r\n3. You stop to make sure no one is looking and you open it and attempt to hot wire it.<br /> \r\n''',
        '<font color=green>4.You hear it crank over!<br />\r\n\r\n<font color=green>Result: \r\n You speed off you in your new hummer!</font>',
        '<font color=orange>4. You wire it wrong and blow a fuse.<br />\r\n5. The Alarm starts screeching.<br />\r\n\r\n<font color=brown>Result: you run of before somebody notices you. Bad Luck.</font> ',
        '<font color=red>to late the cops seen ya', 56, 'got caught stealing a hummer', 56);
INSERT INTO `crimes`
VALUES (19, 'F-150', 25, '((WILL*0.7)/25)+(LEVEL/4)', 0, 0, 8010, 4,
        '1. You head down to the local car lot.<br />\r\n2. You spot a F-150, ooh it looks neat!<br />\r\n3. You throw a rock at the window, but then spy a security camera attached to the steering wheel.<br />\r\n4. You jump in, make sure you''re out of the camera''s view, and attempt to work it out of its socket.<br />''',
        '<font color=green>5. The camera pops out, you smile and throw it away.<br />\r\nResult: You insert your fake key and take off you now have a new F-150!',
        '<font color=orange>Result: The camera won''t budge. You abandon your attempt and walk home. You Encounter Cops that seen the whole thing!',
        '<font color=red>you got busted for GTA', 50, 'busted by the cops for jacking cars', 50);
INSERT INTO `crimes`
VALUES (20, 'Industrialist', 15, '((WILL*0.8)/15)+(LEVEL/4)', 2000, 0, 0, 5,
        '1. You arm yourself with your trusty M16 and meet your accomplice at the bus station. He gives you the job.<br />\r\n2. You drive to the target''s mansion.<br />\r\n3. He steps out of his car, you tense up and get ready to fire.<br />''',
        '<font color=green>4. You blow his head off.<br />\r\n<font color=green>Result: You drive home to find ${money} in your Mail Box for the job!</font>',
        '<font color=orange><font color=brown>Result: You wrongly identified the Industrialist, you blew a street walker''s head off instead! Unlucky!</font> ',
        '<font color=red>you got busted for murder', 35, 'got busted for murder', 35);
INSERT INTO `crimes`
VALUES (21, 'Coke Dealer', 25, '((WILL*0.7)/25)+(LEVEL/4)', 25000, 0, 0, 5,
        '1. You Recieved a call for a job downtown.<br />\r\n2. You arm yourself with your trusty Sniper Rifle and head down to the Designated Area.<br />\r\n3. The Target shows up about to get into his car.<br />\r\n\r\n''',
        '<font color=green>4. You Take his head off clean in 1 shot.<br />\r\n<font color=green>Result: You drive home to find ${money} in your Mail Box!</font>',
        '<font color=orange>4. the target steps into the car and prepares to drive off.<br />\r\n5. Yours still trying to peice your gun together but forgot what part goes where.<br />\r\n\r\n<font color=brown>Result: He Drives off safely! Bad Luck!</font> ',
        '<font color=red>you got busted for murder', 50, 'got busted for murder', 50);
INSERT INTO `crimes`
VALUES (22, 'Kill a Rich Guy', 75, '((WILL*0.7)/35.9)+(LEVEL/16)', 140000, 0, 0, 5,
        '1. You arm yourself with your trusty Arsenal Shipka and meet your partner at the bus station. He gives you the job.<br />\r\n2. You drive to the target''s mansion.<br />\r\n3. You step out of your car, you get fired up and get ready to fire.<br />''',
        '<font color=green>4. You blow his head off.<br />\r\n<font color=green>Result: You drive home to find ${money} in your mailbox for the job!</font>',
        '<font color=orange><font color=brown>Result: You wrongly identified the target, you blew a street walker''s head off instead! Looks Like Jail time for you!</font> ',
        '<font color=red>you got busted ', 150, 'got busted for murder', 150);
INSERT INTO `crimes`
VALUES (23, 'Hired Gun', 150, '((WILL*0.7)/35.9)+(LEVEL/100)', 4000000, 0, 0, 5, 'You get hired on for a Hit.''',
        '<font color=green>You go meet the man at a shop. you get a pic of your mark you go to find the mark.you find him at the mall you get shot 3 shoots off at him you have killed the mark you go back to the shop and meet the man there you, get ${money}! for a job well done! ',
        '<font color=orange>You go meet the man at the shop. you get a pic of your mark you go to find the mark.you find him you get shot 3 shoots off, but you missed and hit a cop car, that was dumb now you are going to jail, say hi to bubba lol  ',
        '<font color=red>you got busted for murder', 300, 'got busted for murder', 300);
INSERT INTO `crimes`
VALUES (24, 'Street Person', 6, '((WILL*0.8)/6)+(LEVEL/4)', 50, 0, 0, 6,
        '1. You go down the street searching for a Street Person.<br />\r\n2. You see a particularly nice-looking Street Person dozing on the sidewalk.<br />\r\n3. You bend down and stick your hand into his pocket.<br />',
        '4. You grab some notes and run away.<br />\r\n<font color=green>Result: You count up the notes, there''s ${money}!</font>',
        '<font color=brown>The Street Person stirs. You dash away, not wanting to let him see you.</font>',
        'you got busted', 15, 'busted by the cops', 20);
INSERT INTO `crimes`
VALUES (25, 'Punk', 6, '((WILL*0.8)/6.5)+(LEVEL/4)', 100, 0, 0, 6,
        '1. You go down the street searching for a Punk.<br />\r\n2. You see a kid listening to his walkman walk down the sidewalk.<br />\r\n3. You quietly go up to him and put a hand into his pocket.<br />',
        '4. You grab a wallet and run away.<br />\r\n<font color=green>Result: You open the wallet and count up the notes, there''s ${money}!</font>',
        '<font color=brown>Result: You hit his pocket protector, you walk away slowly.</font>', 'you got busted', 25,
        'busted by the cops', 25);
INSERT INTO `crimes`
VALUES (26, 'Enterprise Man', 6, '((WILL*0.8)/6.9)+(LEVEL/4)', 150, 0, 0, 6,
        '1. You go down the street searching for a normal everyday Enterprise Man.<br />\r\n2. You see a man briskly walking, carrying a black bag.<br />\r\n3. You quietly go up to him and reach a hand out for his bag.<br />',
        '4. You grab it and dash off down an streetway.<br />\r\n<font color=green>Result: You open the bag and count up the money, there''s ${money}!</font>',
        '<font color=brown>Result: You cop one in the nose as he shoos you away.</font>', 'you got busted', 25,
        'busted by the cops', 25);
INSERT INTO `crimes`
VALUES (27, 'Broken Down Home', 10, '((WILL*0.8)/10)+(LEVEL/4)', 260, 0, 0, 6,
        '1. You head to a back street where there are lots of Broken Down Homes.<br />\r\n2. You find a particularly nice-looking Broken Down Home, check that there''s no-one inside, and break open the door.<br />\r\n3. You start searching the draws.<br />',
        '<font color=green>Result: You find ${money} in a lower draw!</font>',
        '<font color=brown>Result: You hear footsteps. You don''t know if they are coming towards this Broken Down Home, but you can''t take the risk. You dash away with nothing in your pocket.</font>',
        'you got busted', 25, 'busted by the cops', 25);
INSERT INTO `crimes`
VALUES (28, 'Condo', 11, '((WILL*0.8)/11)+(LEVEL/4)', 400, 0, 0, 6,
        '1. You head over to your buds to pick up your assignment.<br />\r\n2. He gives you a piece of paper with the address on it. You hop in your car and drive there.<br />\r\n3. You throw a large rock at the window of the Condo and hop in.<br />\r\n4. You start searching for the MAc your bud told you to steal for him.<br />',
        '5. You find the MAc, it looks pretty new and powerful!<br />\r\n6. You disconnect the MAc from the power at the wall, disconnect the various wires, and pack it all into a cardboard box as tall as your head.<br />\r\n7. You carry the box into your car and drive back to your bud''s.<br />\r\n<font color=green>Result: As promised, he gives you 20% of the MAc''s worth. You feel highly content with the ${money} in your wallet.</font>',
        '<font color=brown>Result: The alarm sounds. You get out as fast as possible and drive away.</font>',
        'you got busted', 25, 'busted by the cops', 25);
INSERT INTO `crimes`
VALUES (29, 'Rob the Casino', 35, '((WILL*0.6)/35)+(LEVEL/5)', 70000, 0, 0, 6,
        'Rob the Casino\r\n1. You set up the equipment required.<br />\r\n2. You Start developing some fake casino Chips.<br />\r\n3. You pack the Chips into the Suit case and Head of to the local Casino.<br />\r\n4. Once inside u Bet $70000 in a single game of BlackJack.<br />',
        ...
        'you got busted', 70, 'got robben the casino', 70);
INSERT INTO `crimes`
VALUES (30, 'Rob the Dealer', 45, '((WILL*0.7)/35)+(LEVEL/5)', 80000, 0, 0, 6,
        'Rob the Dealer\r\n1. You set up the equipment required.<br />\r\n2. You Start developing some fake Dealer Chips.<br />\r\n3. You pack the Chips into the Suit case and Head of to the local Dealer.<br />\r\n4. Once inside u Bet ${money} in a single game of BlackJack the dealer sees threw fake you hit him over the head and swipe the cash.<br />',
        '<font color=green>Result: Operion Success!\r\n\r\nYou got ${money} and took off running!</font>\r\n',
        '<font color=brown>Result: \r\n\r\nGot caught by Security Guards.</font>', 'you got busted', 90,
        'got caught robbin the dealer', 90);
INSERT INTO `crimes`
VALUES (31, 'Rob the Bookie', 50, '((WILL*0.7)/35)+(LEVEL/5)', 90000, 0, 0, 6,
        'Rob the Bookie\r\n1. You set up the equipment required.<br />\r\n2. You Start developing some fake Chips.<br />\r\n3. You pack the Chips into the Suit case and Head of to the local Dealer.<br />\r\n4. Once inside u Bet and lose on purpose in games of BlackJack to buy your time.<br />',
        '<font color=green>Result: Operation Success!\r\n\r\nYou goto the back room and steal ${money}! </font>\r\n',
        '<font color=brown>Result: \r\n\r\nGot caught by Security Guards.</font>', 'you got busted', 100,
        'got caught robbin the bookie', 100);
INSERT INTO `crimes`
VALUES (32, 'Simple Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 400, 0, 0, 7,
        '<font color = orange>Mr biggs gives you a call on your phone \r\nhes say he will pay you $800 dollars to infect bob''s computer\r\nwith a simple virus,You grab your simple virus disk connect to bob''s computer\r\nand upload the virus!',
        '<font color = green>You Success Fully Uploaded the Virus\r\n',
        ...
        'Got busted by the Fbi for infecting people with Simple Viruses!', 25);
INSERT INTO `crimes`
VALUES (33, 'Polymorphic Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 600, 0, 0, 7,
        ...
        '<font color = red>While uploading the virus the feds bust in and take you to jail!\r\n',
        '<font color = maroon>Your in cuffs time for jail!\r\n', 30,
        'Got busted by the Fbi for infecting people with Polymorphic Viruses!', 25);
INSERT INTO `crimes`
VALUES (34, 'Tunnelling Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 700, 0, 0, 7,
        ...
        '<font color = red>While uploading the virus the feds bust in and take you to jail!\r\n',
        '<font color = maroon>Your in cuffs time for jail!\r\n', 33,
        'Got busted by the Fbi for infecting people with Tunnelling Viruses!', 25);
INSERT INTO `crimes`
VALUES (35, 'Boot Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 800, 0, 0, 7,
        ...
        '<font color = red>While uploading the virus the feds bust in and take you to jail!\r\n',
        '<font color = maroon>Your in cuffs time for jail!\r\n', 35,
        'Got busted by the Fbi for infecting people with Boot Viruses!', 25);
INSERT INTO `crimes`
VALUES (36, 'Macro Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 900, 0, 0, 7,
        ...
        '<font color = red>While uploading the virus the feds bust in and take you to jail!\r\n',
        '<font color = maroon>Your in cuffs time for jail!\r\n', 40,
        'Got busted by the Fbi for infecting people with Macro Viruses!', 25);
INSERT INTO `crimes`
VALUES (37, 'Active X Virus', 9, '((WILL*0.8)/10)+(LEVEL/4)', 950, 0, 0, 7,
        ...
        '<font color = red>While uploading the virus the feds bust in and take you to jail!\r\n',
        '<font color = maroon>Your in cuffs time for jail!\r\n', 45,
        'Got busted by the Fbi for infecting people with Active X Viruses!', 25);
...
VALUES (1, 'Secretary', 1, 200, 2, 5, 3, 100, 150, 120);
INSERT INTO `jobranks`
VALUES (2, 'Med Student', 1, 500, 7, 20, 10, 250, 400, 320);
INSERT INTO `jobranks`
VALUES (3, 'Nurse', 1, 1000, 15, 30, 18, 1000, 1500, 1200);
INSERT INTO `jobranks`
VALUES (4, 'Pediatrician', 1, 2000, 20, 38, 25, 1750, 2250, 2000);
INSERT INTO `jobranks`
VALUES (5, 'Surgeon', 1, 3500, 25, 45, 32, 3000, 4000, 3500);
INSERT INTO `jobranks`
VALUES (6, 'Custodian', 2, 50, 1, 6, 3, 10, 10, 10);
INSERT INTO `jobranks`
VALUES (7, 'Burger Flipper', 2, 200, 3, 20, 10, 20, 75, 40);
INSERT INTO `jobranks`
VALUES (8, 'Drive-Thru Cashier', 2, 500, 5, 30, 15, 50, 1200, 750);
INSERT INTO `jobranks`
VALUES (9, 'Cashier', 2, 1000, 8, 37, 23, 100, 2000, 1750);
INSERT INTO `jobranks`
VALUES (10, 'Manager', 2, 2000, 15, 45, 30, 200, 5000, 2500);
INSERT INTO `jobranks`
VALUES (11, 'Probation Officer', 3, 150, 2, 3, 3, 90, 100, 100);
INSERT INTO `jobranks`
VALUES (12, 'Sargeant', 3, 400, 5, 10, 12, 200, 300, 325);
INSERT INTO `jobranks`
VALUES (13, 'Lieutenant', 3, 850, 10, 20, 25, 600, 1300, 1500);
INSERT INTO `jobranks`
VALUES (14, 'Captain', 3, 1700, 17, 27, 32, 1000, 3000, 3750);
INSERT INTO `jobranks`
VALUES (15, 'Chief', 3, 3000, 20, 40, 45, 2500, 5500, 8500);
INSERT INTO `jobranks`
VALUES (16, 'Mayor', 4, 250, 1, 2, 1, 40, 250, 75);
INSERT INTO `jobranks`
VALUES (17, 'Governor', 4, 700, 5, 7, 3, 100, 800, 250);
INSERT INTO `jobranks`
VALUES (18, 'Senator', 4, 1750, 9, 13, 7, 250, 2000, 750);
INSERT INTO `jobranks`
VALUES (19, 'Vice-President', 4, 4000, 12, 17, 13, 750, 5000, 2000);
INSERT INTO `jobranks`
VALUES (20, 'President', 4, 10000, 15, 25, 20, 2500, 15000, 5000);
...
INSERT INTO `jobs`
VALUES (4, 'Politics', 16, 'Become a politician and run this town, literally.', 'Voters');
INSERT INTO `jobs`
VALUES (3, 'Law Enforcement', 11, 'Protect the citizens from the worst of the worst.', 'Officer Blackburn');
INSERT INTO `jobs`
VALUES (2, 'McDaniels', 6, 'Local fast food restaurant known for good eats.', 'Mr. Daniels');
INSERT INTO `jobs`
VALUES (1, 'Hospital', 1, 'Work in the hospital and save lives.', 'Mr. Radcliffe');
...
ALTER TABLE houses
    ADD `hPIC` VARCHAR(255) NOT NULL DEFAULT '';

INSERT INTO `houses` (`hID`, `hNAME`, `hPRICE`, `hWILL`, `hPIC`)
VALUES (3, 'Trailer', 100000, 150, 'housepics/house_img2.jpg'),
...
INSERT INTO `cities` (`cityid`, `cityname`, `citydesc`, `cityminlevel`, `citytravtime`)
VALUES (2, 'Spain', 'This is where the illegal becomes legal', 1, 2),
...
INSERT INTO `itemtypes` (`itmtypeid`, `itmtypename`)
VALUES (1, 'Food'),
       (2, 'Electronics'),
       (3, 'Melee Weapon'),
       (4, 'Gun'),
...
VALUES (1, 1, 'Sack Lunch', 'Deliciously filled with nutrients. Even has a slice of your favorite cake!', 95000, 0, 1),
       ...
       (78, 6, 'Nuclear Bomb',
        'Can kill anyone in one blow even though the guy is lvl 100000000 and has there stats higher than everyone! ****This weapon is restricted to poor people, but still can be buyable for a high enough prize****NOTE: This weapon can kill every member in the game and can gain you heaps of exp ! The Deadlyest weapon in the whole world',
        1000000000, 0, 0),
...
INSERT INTO `shops` (`shopID`, `shopLOCATION`, `shopNAME`, `shopDESCRIPTION`)
VALUES (6, 1, 'Industrial Weapons', 'All the high techweapons you could need'),
