...
<td>ID to send to:</td> <td><input type='text' STYLE='color: black;  background-color: white;' name='userid' value='{$_GET['ID']}'/></td></tr><tr>
...
</td></tr><td colspan=2><input type='submit' STYLE='color: black;  background-color: white;' value='Send' class='btn'></td></tr></table></form></div><div><img src='images/generalinfo_btm.jpg' alt='' /></div><br></div></div></div></div></div>
EOF;
